...
import { StackModal } from '../../create-project/_components/stack-modal'

export const EditProjectForm = ({ id }: { id: string }) => {
  const project = projects.find((project) => project.userId === id)
